...
const UpcomingEvents = () => {
  return (
    <div className="bg-gray-800 p-6 rounded-xl shadow-2xl w-full max-w-2xl mt-10 border-2 border-[#00B6BA] flex flex-col gap-6 transition-transform transform hover:scale-105">
      ...
      {events.map((event, index) => (
        <motion.div
          ...
          className="bg-gray-700 p-6 rounded-lg shadow-md flex items-center justify-between transition-transform transform hover:scale-105 hover:bg-gray-600 hover:shadow-lg hover:shadow-[#00B6BA]/50"
        >
